...
{
    /// <inheritdoc />
    public partial class ProductandbasketandOrderModule : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderedItem_ProductId = table.Column<int>(type: "int", nullable: false),
                    OrderedItem_Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
